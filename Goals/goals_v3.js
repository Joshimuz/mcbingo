...
[
	...
	{name: "Bucket of Fish", reactant: "UseBuckets", infrequency: 4, tooltiptext: "Can be any of the types of Fish", tooltipimg: "FishBucket.jpg"},
	...
	{name: "(10-32) Stone", tooltiptext: "NOT Cobblestone", tooltipimg: "Stone.jpg", antisynergy: "Stone", infrequency: 2},
	...
	{name: "(2-3) Different Edible Items", tooltiptext: "Raw and cooked variants count as one (e.g. Raw Beef and Steak)", tooltipimg: "RawAndCooked.jpg", antisynergy: "EdibleItems", infrequency: 2},
...
[
	...
	{name: "Dead Bush"},
	{name: "(15-32) Grass", tooltiptext: "The plant, NOT the block", tooltipimg: "TallGrass.jpg"},
	...
	{name: "(32-64) Stone", tooltiptext: "NOT Cobblestone", tooltipimg: "Stone.jpg", antisynergy: "Stone", infrequency: 2},
	...
	{name: "(4-5) Different Edible Items", tooltiptext: "Raw and cooked variants count as one (e.g. Raw Beef and Steak)", tooltipimg: "RawAndCooked.jpg", antisynergy: "EdibleItems", infrequency: 2},
],

// Medium (2)
[
	{name: "Wither Skull"},
	{name: "(6-7) Different Edible Items", tooltiptext: "Raw and cooked variants count as one (e.g. Raw Beef and Steak)", tooltipimg: "RawAndCooked.jpg", antisynergy: "EdibleItems", infrequency: 2},
	...
	{name: "Finish by jumping from top to bottom of the world", tooltiptext: "Dig a hole to bedrock and build to 256 Y (height limit), then jump from top to bottom at the end of the game", tooltipimg: "FinishTopToBottom.jpg", antisynergy: "Finish"},
	{name: "Vegetarian", tooltiptext: "Never eat meat, including fish", tooltipimg: "NoFish.jpg", antisynergy: "Food"},
	{name: "Carnivore", tooltiptext: "Only eat meat", tooltipimg: "NoBread.jpg", antisynergy: "Food"},
	...
	{name: "Wear 4 Different Armour types at the same time",  tooltiptext: "Example: GOLD shoes, LEATHER Trousers, IRON Chestplate and DIAMOND Helmet", tooltipimg: "4Armour.jpg", reactant: "WearArmour"},
	...
	{name: "Firework Star"},
	{name: "Hang a mob with a lead", tooltiptext: "Suspend a mob in mid air using a fence and a lead", tooltipimg: "HangingLead.jpg"},
	{name: "Blaze Rod"},
	{name: "Ghast Tear"},
	{name: "Never use Coal", tooltiptext: "Never use Coal for any crafting recipes, fuel in a furnace or trades, CAN use Charcoal", tooltipimg: "NoCoal.jpg"},
	...
	{name: "Never use a Sword", catalyst: "SwordUse", tooltiptext: "Never use a Sword for Combat or Block Breaking. Holding or crafting is fine.", tooltipimg: "NoSword.jpg"},
	{name: "Deplete an Iron Sword", reactant: "SwordUse", tooltiptext: "Use an Iron Sword until it breaks, if you are unsure if you did check the Statistics screen!", tooltipimg: "SwordDepelete.jpg"},
	...
	{name: "Water Bucket, Lava Bucket, Milk Bucket, Bucket of Fish", antisynergy: "BucketTypes", reactant: "UseBuckets", tooltiptext: "Can be any of the types of Fish", tooltipimg: "FishBucket.jpg"},
...
[
	...
	{name: "Get a Zombie Pigman's Sword", tooltiptext: "Get the rare Golden Sword item drop from a Pigman", tooltipimg: "GoldenSword.jpg"},
	{name: "Finish by launching Fireworks of (5-10) Different Colours", antisynergy: "Finish"},
	{name: "Nametag an Enderman"},
	{name: "Kill yourself with an Ender Pearl", tooltiptext: "Need to die to the damage taken from USING a pearl (not subsequent fall/other damage)", tooltipimg: "EnderPearl.jpg", reactant: "Death"},
	...
	{name: "Build a (2-4)x(2-4)x(2-4) Ice cube", tooltiptext: "You can choose what shall be the width/length/height.", tooltipimg: "IceCube.jpg"},
	...
	{name: "Finish on top of a stairway to Heaven", tooltiptext: "Using Stairs, build up to 256 Y (the height limit) and stand on the top at the end of the game (If you need to jump over a block it's not a finished stairway)", tooltipimg: "FinishStairs.jpg", antisynergy: "Finish"},
...
[
	...
	{name: "Place 1 of each Mineral block on top of each other", tooltiptext: "Coal, Iron, Gold, Diamond, Redstone, Lapis, Emerald and Quartz blocks", tooltipimg: "MineralBlocks.jpg"},
	...
	{name: "5 types of Coral Blocks", tooltiptext: "The alive stuff, not the Dead Coral Blocks", tooltipimg: "CoralBlocks.jpg"},
	{name: "(32-64) Blue Ice"},
