...
[
	...
	{name: "Bucket of Fish", antisynergy: ["FishBucket"], reactant: ["UseBuckets"], infrequency: 4, tooltiptext: "Can be any of the types of Fish.", tooltipimg: "FishBucket.jpg", tags: [Item, Ocean, Overworld]},
	...
	{name: "Build a (2-4)x(2-4)x(2-4) leaf cube", tooltiptext: "You can choose what shall be the width/length/height.", tooltipimg: "LeafCube.jpg", tags: [Build, Overworld]},
	...
	{name: "(10-32) Stone", tooltiptext: "NOT Cobblestone.", tooltipimg: "Stone.jpg", antisynergy: ["Stone"], infrequency: 2, reactant: ["UseFurnace"], tags: [Item, Overworld]},
	...
	{name: "(2-3) Different Edible Items", tooltiptext: "Raw and Cooked variants count as one (e.g. Raw Beef and Steak).", tooltipimg: "RawAndCooked.jpg", antisynergy: ["EdibleItems"], infrequency: 2, tags: [Item]}, // not tagged with Overworld, because you can get 3 in the Nether
	...
	{name: "Fill a Composter", tooltiptext: "Add stuff until you can get Bonemeal out!", tooltipimg: "FullComposter.jpg", tags: [Action]},
],
...
[
	...
	{name: "2 Creepers in the same Boat", tooltiptext: "The 2 Creepers must be in the same boat at the same time.", tooltipimg: "2creepers1boat.jpg", tags: [Action, Combat, Overworld]},
	...
	{name: "(15-32) Grass", tooltiptext: "The tall stuff, NOT the block.", tooltipimg: "TallGrass.jpg", tags: [Item, Overworld]},
	...
	{name: "Finish where you spawned using a Compass", tooltiptext: "Be stood close enough to spin your compass within a couple blocks at the end of the game.", tooltipimg: "Compass.jpg", tags: [Action, Overworld, Finish]},
	{name: "(32-64) Stone", tooltiptext: "NOT Cobblestone.", tooltipimg: "Stone.jpg", antisynergy: ["Stone"], infrequency: 2, reactant: ["UseFurnace"], tags: [Item, Overworld]},
	...
	{name: "(4-5) Different Edible Items", tooltiptext: "Raw and Cooked variants count as one (e.g. Raw Beef and Steak).", tooltipimg: "RawAndCooked.jpg", antisynergy: ["EdibleItems"], infrequency: 2, tags: [Item, Overworld]},
	...
	{name: "Open a Door with a Target Block from 10 blocks away", tooltiptext: "YOU have to be 10 blocks away, not the Target Block from the Door.", tooltipimg: "TargetAndDoor.jpg",  tags: [Action, Overworld]},
	...
	{name: "Never use a Sword", catalyst: ["SwordUse"], tooltiptext: "Never use a Sword for Combat or Block Breaking. Holding or crafting is fine.", tooltipimg: "NoSword.jpg", tags: [Never]},
	{name: "Carnivore", tooltiptext: "Only eat meat.", tooltipimg: "NoBread.jpg", antisynergy: ["Food"], tags: [Never, Action], catalyst: ["EatNonMeat"]},
...
// Medium (2)
[
	{name: "(6-7) Different Edible Items", tooltiptext: "Raw and Cooked variants count as one (e.g. Raw Beef and Steak).", tooltipimg: "RawAndCooked.jpg", antisynergy: ["EdibleItems"], infrequency: 2, tags: [Item, Overworld]},
	...
	{name: "Finish by jumping from top to bottom of the world", tooltiptext: "Dig a hole to Bedrock, build to Y=256 (height limit), then jump from top to bottom at the end of the Bingo.", tooltipimg: "FinishTopToBottom.jpg", tags: [Action, Build, Overworld, Finish]},
	{name: "Vegetarian", tooltiptext: "Never eat meat, including fish.", tooltipimg: "NoFish.jpg", antisynergy: ["Food"], tags: [Never, Action], catalyst: ["EatMeat"]},
	...
	{name: "Finish on top of the world", tooltiptext: "Build up to Y=256 (height limit) and stand on the top at the end of the Bingo.", tooltipimg: "FinishTop.jpg", tags: [Action, Build, Finish]},
	...
	{name: "Activate a (4-6)x(4-6) Nether Portal (not counting corners)", tooltiptext: "Width/height of the Obsidian frame, disregarding corners (or in other words, width/height of the—once activated—purple portal area).", tooltipimg: "Portal.jpg", tags: [Action, Build, Nether]},
	...
	{name: "Wear 4 Different Armour types at the same time",  tooltiptext: "Example: GOLD shoes, LEATHER Trousers, IRON Chestplate and DIAMOND Helmet.", tooltipimg: "4Armour.jpg", reactant: ["WearArmour"], tags: [Action]},
	...
	{name: "Hang a mob with a Lead", reactant: ["Pacifist"], tooltiptext: "Suspend a mob in mid air using Fences and a Lead.", tooltipimg: "HangingLead.jpg", tags: [Action, RareBiome, Overworld]},
	{name: "Blaze Rod", reactant: ["Pacifist"], tags: [Item, Nether, Combat]},
	{name: "Ghast Tear", reactant: ["Pacifist"], tags: [Item, Nether, Combat]},
	{name: "Never use Coal", tooltiptext: "Never use Coal for any crafting recipes or fuel in a Furnace, CAN use Charcoal.", catalyst: ["NeverCoal"], tooltipimg: "NoCoal.jpg", tags: [Never]},
	...
	{name: "Deplete an Iron Sword", reactant: ["SwordUse"], tooltiptext: "Use an Iron Sword until it breaks, check the 'Items' statistics screen!", tooltipimg: "SwordDepelete.jpg", tags: [Action, Stat]},
	...
	{name: "Water, Lava, Milk and Fish Bucket", antisynergy: ["BucketTypes", "WaterBucket", "LavaBucket", "MilkBucket", "FishBucket"], reactant: ["UseBuckets"], tooltiptext: "Can be any of the types of Fish.", tooltipimg: "FishBucket.jpg", tags: [Item, Overworld]},
	...
	{name: "Kill yourself with an Ender Pearl", tooltiptext: "Need to die to the small fall damage taken from using a Pearl.", tooltipimg: "EnderPearl.jpg", reactant: ["Pacifist"], tags: [Action]},
	{name: "Grass Block", tooltiptext: "If you don't have Silk Touch, I know a guy who might pick one up for you...", tooltipimg: "GrassBlock.jpg", tags: [Item, Overworld]},
	{name: "Bounce on a Slime Block", tooltiptext: "Get a Slime Block, place it on the ground and give it a good old bouncin' on.", tooltipimg: "SlimeBlock.jpg", tags: [Action, Overworld]},
...
[
	...
	{name: "Sponge", tooltiptext: "DRY Sponge, not a Wet one", tooltipimg: "Sponge.jpg", tags: [Item, Ocean, Overworld]},
	...
	{name: "Get a Zombified Piglin's Sword", reactant: ["Pacifist"], tooltiptext: "Kill Zombified Piglins until you get a rare drop from one, it being their Golden Sword.", tooltipimg: "GoldenSword.jpg", tags: [Action, Combat, Nether]},
	...
	{name: "Build a (2-4)x(2-4)x(2-4) Ice cube", tooltiptext: "You can choose what shall be the width/length/height.", tooltipimg: "IceCube.jpg", tags: [Build, Overworld]},
	{name: "Finish on top of a stairway to Heaven", tooltiptext: "Using Stairs, build up to Y=256 (height limit) and stand on top at the end of the Bingo. (If you need to jump over a block, it's not a finished stairway.)", tooltipimg: "FinishStairs.jpg", tags: [Build, Overworld, Finish]},
	...
	{name: "Build a 6x6 Scaffolding n Shape (not counting corners)", tooltiptext: "Width/height of the inside frame, disregarding corners.", tooltipimg: "ScaffingN.jpg", tags: [Build, Overworld]},
...
// Very Hard (4)
[
	{name: "(5-7) Different Ores", tooltiptext: "Coal, Diamond, Emerald, Gold, Iron, Lapis Lazuli, Nether Quartz, Nether Gold and Redstone Ores are your choices.", tooltipimg: "Ores.jpg", tags: [Item, Overworld]},
	...
	{name: "Every type of Chestplate", tooltiptext: "Leather, Gold, Chainmail, Iron, Diamond and yes, even Netherite.", tooltipimg: "chainmail chest.jpg", tags: [Item, Combat]},
	...
	{name: "Every colour of Dye", reactant: ["UseFurnace"], antisynergy: ["EveryColour"], infrequency: 2, tooltiptext: "Black, Blue, Brown, Cyan, Grey, Green, Light Blue, Light Grey, Lime, Magenta, Orange, Pink, Purple, Red, White and Yellow!", tooltipimg: "EveryColourOfDye.png", tags: [Item, Colour, Overworld]},
	...
	{name: "Place 1 of each Mineral block on top of each other", tooltiptext: "Coal, Iron, Gold, Diamond, Redstone, Lapis, Emerald, Quartz and Netherite blocks.", tooltipimg: "MineralBlocks.jpg", tags: [Item, Build, Overworld, Nether]},
	{name: "Sleep in a Woodland Mansion", tags: [Action, RareBiome, Overworld]},
	{name: "(10-32) Mycelium", tags: [Item, RareBiome, Overworld]},
	{name: "5 types of Coral Blocks", tooltiptext: "The alive stuff, not the Dead Coral Blocks.", tooltipimg: "CoralBlocks.jpg", tags: [Item, RareBiome, Ocean, Overworld]},
	...
	{name: "Place every colour of Bed next to each other", reactant: ["UseFurnace"], antisynergy: ["EveryColour"], infrequency: 2, tooltiptext: "Black, Blue, Brown, Cyan, Grey, Green, Light Blue, Light Grey, Lime, Magenta, Orange, Pink, Purple, Red, White and Yellow!", tooltipimg: "EveryBed.jpg", tags: [Action, Colour, Overworld]},
