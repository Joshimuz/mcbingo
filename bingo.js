...
function generateNewSheet()
{
    ...
    if ($("body").hasClass(SHOW_TAG_CUSTOMISATION_CLASS_NAME))
	{
        VERSION.tagList.forEach((tag, index) => {
			updateTagCustomisationSlider(index); // customisation.js
        });
    }
}
...
function changeDifficulty(value)
{
	...
	updateDefaultTags(value); // customisation.js
...
function pushNewUrl()
{
	...
	var tags = getTagsURL(); // customisation.js
...
function updateVersion()
{
	...
	updateTagsButton(); // customisation.js
