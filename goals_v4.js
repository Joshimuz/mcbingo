...
[
	...
	{name: "(10-32) Stone", tooltiptext: "NOT Cobblestone.", tooltipimg: "Goal Tooltip Images/Stone.jpg", antisynergy: ["Stone"], frequency: 2, reactant: ["UseFurnace"], tags: [Item, Overworld]},
	...
	{name: "(2-5) Raw Cod", antisynergy: ["RawCod"], frequency: 2, tags: [Item, Ocean, Overworld]},
	{name: "(2-5) Raw Salmon", antisynergy: ["RawSalmon"], frequency: 2, tags: [Item, Ocean, Overworld]},
	...
	{name: "(10-32) Sand", antisynergy: ["Sand"], frequency: 2, tags: [Item, Overworld]},
	{name: "(5-10) Sandstone", antisynergy: ["Sandstone"], frequency: 2, tags: [Item, Overworld]},
	{name: "(5-10) Cut Sandstone", antisynergy: ["Sandstone"], frequency: 2, tags: [Item, Overworld]},
	{name: "(2-5) Paper", antisynergy: ["Paper"], frequency: 2, tags: [Item, Overworld]},
...
[
	...
	{name: "(4-7) Colours of Terracotta", reactant: ["UseFurnace"], antisynergy: ["TerracottaColour"], frequency: 4, tags: [Item, Colour, Overworld]},
	...
	{name: "(5-15) Ink Sacs", antisynergy: ["InkSacs"], frequency: 2, tags: [Item, Overworld]},
	...
	{name: "Green Dye", reactant: ["UseFurnace"], frequency: 10, tags: [Item, RareBiome, Overworld]},
	...
	{name: "(5-7) Different Flowers", antisynergy: ["Flowers"], frequency: 2, tags: [Item, Overworld]},
	{name: "(3-6) Colours of Concrete", antisynergy: ["ConcreteColour"], frequency: 4, tags: [Item, Colour, Overworld]},
	{name: "(3-6) Colours of Glazed Terracotta", reactant: ["UseFurnace"], antisynergy: ["GlazedColour"], frequency: 4, tags: [Item, Colour, Overworld]},
	...
	{name: "(32-64) Stone", reactant: ["UseFurnace"], tooltiptext: "NOT Cobblestone.", tooltipimg: "Goal Tooltip Images/Stone.jpg", antisynergy: ["Stone"], frequency: 2, tags: [Item, Overworld]},
	...
	{name: "(6-15) Raw Salmon", antisynergy: ["RawSalmon"], frequency: 2, tags: [Item, Ocean, Overworld]},
	...
	{name: "(33-64) Sand", antisynergy: ["Sand"], frequency: 2, tags: [Item, Overworld]},
	{name: "(11-32) Sandstone", antisynergy: ["Sandstone"], frequency: 2, tags: [Item, Overworld]},
	{name: "(11-32) Cut Sandstone", antisynergy: ["Sandstone"], frequency: 2, tags: [Item, Overworld]},
	{name: "(6-15) Paper", antisynergy: ["Paper"], frequency: 2, tags: [Item, Overworld]},
...
[
	...
	{name: "Finish by jumping from top to bottom of the world", tooltiptext: "Dig a hole to Bedrock, build to Y=256 (height limit), then jump from top to bottom at the end of the Bingo.", tooltipimg: "Goal Tooltip Images/FinishTopToBottom.jpg", antisynergy: ["Finish"], tags: [Action, Build, Overworld]},
	...
	{name: "Finish on top of the world", tooltiptext: "Build up to Y=256 (height limit) and stand on the top at the end of the Bingo.", tooltipimg: "Goal Tooltip Images/FinishTop.jpg", antisynergy: ["Finish"], tags: [Action, Build]},
	...
	{name: "(8-11) Colours of Terracotta", reactant: ["UseFurnace"], antisynergy: ["TerracottaColour"], frequency: 4, tags: [Item, Colour, Overworld]},
	{name: "(7-10) Colours of Glazed Terracotta", reactant: ["UseFurnace"], antisynergy: ["GlazedColour"], frequency: 4, tags: [Item, Colour, Overworld]},
	...
	{name: "(8-10) Different Flowers", antisynergy: ["Flowers"], frequency: 2, tags: [Item, Overworld]},
	...
	{name: "Get a Pillager's Crossbow", reactant: ["Pacifist"], tooltiptext: "Kill Pillagers until you get a rare Crossbow drop from one.", tags: [Item, Combat, Overworld]},
...
[
	...
	{name: "(12-14) Colours of Wool", antisynergy: ["WoolColour"], frequency: 4, tags: [Item, Colour, Overworld]},
	{name: "(12-14) Colours of Terracotta", reactant: ["UseFurnace"], antisynergy: ["TerracottaColour"], frequency: 4, tags: [Item, Colour, Overworld]},
	{name: "(11-14) Colours of Glazed Terracotta", reactant: ["UseFurnace"], antisynergy: ["GlazedColour"], frequency: 4, tags: [Item, Colour, Overworld]},
	...
	{name: "Finish on top of a stairway to Heaven", tooltiptext: "Using Stairs, build up to Y=256 (height limit) and stand on top at the end of the Bingo. (If you need to jump over a block, it's not a finished stairway.)", tooltipimg: "Goal Tooltip Images/FinishStairs.jpg", antisynergy: ["Finish"], tags: [Build, Overworld]},
	...
	{name: "Finish by building a Scaffolding tower, then removing it", tooltiptext: "Build a 1x1 Scaffolding Tower from Bedrock to Y=256 (height limit) and then knock it all down as the final goal.", antisynergy: ["Finish"], tags: [Build, Overworld]},
...
[
	...
	{name: "Every colour of Dye", reactant: ["UseFurnace"], tooltiptext: "Black, Blue, Brown, Cyan, Grey, Green, Light Blue, Light Grey, Lime, Magenta, Orange, Pink, Purple, Red, White and Yellow!", tooltipimg: "Goal Tooltip Images/EveryColourOfDye.png", tags: [Item, Colour, Overworld]},
	{name: "Level 50", antisynergy: ["Level"], frequency: 2, tags: [Stat]},
